...
--
-- Host: localhost:3306
-- Generation Time: Jun 14, 2022 at 09:21 PM
...
CREATE TABLE `akta` (
  ...
  `formulir` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Table structure for table `formulirtambahan`
--

CREATE TABLE `formulirtambahan` (
  `id` bigint UNSIGNED NOT NULL,
  `formulir` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
(5, '2022_06_14_022916_create_akta_table', 1),
(6, '2022_06_14_022922_create_kk_table', 1),
(7, '2022_06_14_022938_create_ektp_table', 1),
(8, '2022_06_14_022951_create_pindahdatang_table', 1),
(9, '2022_06_14_023001_create_formulirtambahan_table', 1);
...
CREATE TABLE `pindahdatang` (
  `id` bigint UNSIGNED NOT NULL,
  `nama` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `formulir` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Indexes for table `formulirtambahan`
--
ALTER TABLE `formulirtambahan`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `formulirtambahan`
--
ALTER TABLE `formulirtambahan`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
